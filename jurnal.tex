...
The positive or negative sign of log-likelihood does not definitively indicate which model is the better fit. 
...
If this $\rho$-value is small (less than 0.1) then the sign is reliable indicator of which model is the better fit to the data. 
If $\rho$-value is large the sign is not reliable and the test does not favor either model over the other. 
