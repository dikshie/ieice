...
\begin{figure*}[!t]
\begin{center}
\subfloat[CDF plot of $\rho$ value of log-likehood ratio test for power-law vs log-normal. Only $5.5\%$ $\rho$ values are less than $0.1$]{
{\includegraphics[width=3.1in]{graphs/non-nested/aggregate-p-cdf-non-nested-lognorm.eps}}
{\label{fig:cdf-p-lognorm}}}
\subfloat[Scatter plot of log-likehood ratio for power-law vs log-normal for $\rho$ values less than $0.1$. All of log-likelihood ratio values sign are negative.]{
