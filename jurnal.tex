...
\titlenote{Short version of this paper was presented in IEEE Netscicom 2011}
...
As mentioned before, eventhough P2P traffic is declining in term of proportion to the global traffic, in absolute term P2P traffic itself slowly growing as shown by the Cisco visual networking index \cite{index2010forecast}. 
...
\begin{figure}[tb]
\begin{center}
\includegraphics[scale=0.3]{graphs/pex_2.eps}
\end{center}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[scale=0.6]{graphs/output.eps}
\end{center}
...
\end{center}
\caption{CDF plot of $p$ for power-law vs log-normal.}
...
\end{center}
\caption{Scatter plot of log-likehood ratio for power-law vs log-normal.}
...
Only less than $6\%$ of $\rho$-value less than $0.1$.   
...
\end{center}
\caption{CDF plot of $p$ for power-law vs exponential.}
\label{fig:cdf-p-exp}
\end{figure}
\begin{figure}[tb]
\begin{center}
...
\end{center}
\caption{Scatter plot of log-likehood ratio for power-law vs exponential.}
...
In that case, it is important to look at physical motivation or theoretical factors or design factors behind the systems to make a sensible judgment. 
...
was born in 1976. 
He received bachelor degree and master degree from
Institute of Technology Bandung.
He is currently Ph.D student at Keio University's
...
communication. He is currently the Dean Faculty of Environment and
