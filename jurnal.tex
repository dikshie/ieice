...
First, while most Bittorrent clients configure the maximum global connection between $200-300$, the maximum connection per torrent (swarm) is set between $50 - 80$ by default \cite{clientv}\cite{clientu}.
