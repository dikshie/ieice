...
\begin{figure*}[!t]
\begin{center}
\subfloat[CDF plot of $\rho$ value of log-likehood ratio test for power-law vs exponential. Only $13\%$ $\rho$ values are less than $0.1$ therefore log-likelihood ratio sign is reliable only for $13\%$ of d    ata points and for the rest, we can not take conclusive answer since log-likelihood ratio sign is not reliable indicator.]{
