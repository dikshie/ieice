...
\begin{figure}
\centering
\epsfig{file=graphs/new/cdf-num.eps, height=2in, width=3.2in}
...
\begin{figure}
\centering
\epsfig{file=graphs/output.eps, width=3.2in}
...
\epsfig{file=graphs/new/aggregate-p-cdf.eps, height=2in, width=3.2in}
...
\begin{figure}
\centering
\epsfig{file=graphs/new/gabung-korelasi-p-rho.eps, height=2in, width=3.2in}
...
\begin{figure}
\centering
\epsfig{file=graphs/new/gabung-korelasi-p-rho-4region.eps, height=2in, width=3.2in}
...
\begin{figure}
\centering
\epsfig{file=graphs/new/cdf-clustering.eps, height=2in, width=3.2in}
