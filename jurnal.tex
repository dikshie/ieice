...
In non-nested case, we compare power-law distribution with log-normal distribution.
...
If this $\rho$-value is small (less than 0.1) then the sign of log-likehood ration is reliable indicator of which model is the better fit to the data. 
