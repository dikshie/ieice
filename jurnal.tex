...
Figure \ref{fig:cdf-p-lognorm} and Fig.\ref{fig:cdf-p-exp} show the CDF of the $\rho$ value for log-likehood ratio between power-law and log-normal distributions and log-likehood ratio between power-law and exponential distributions.
...
Therefore, it is important to look at physical motivation or theoretical factors or design factors behind the systems to make a sensible judgement. 
